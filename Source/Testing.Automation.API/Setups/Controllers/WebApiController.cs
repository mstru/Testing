namespace Testing.Automation.API.Setups.Controllers
{
    ...
    public class WebApiController : ApiController
    {
        ...
        {
            return null;//this.Json(this.responseModel, new JsonSerializerSettings(), Encoding.ASCII);
        }

        public IHttpActionResult JsonWithSettingsAction()
        {
            return null;//this.Json(this.responseModel, TestObjectFactory.GetJsonSerializerSettings());
        }

        public IHttpActionResult JsonWithSpecificSettingsAction(JsonSerializerSettings jsonSerializerSettings)
        {
            return null;//this.Json(this.responseModel, jsonSerializerSettings);
        }
