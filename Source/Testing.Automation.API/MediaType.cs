namespace Testing.Automation.API
{
    ...
    public static class MediaType
    {
        ...
        /// <summary>
        /// Represents application/json (json - utf).
        /// </summary>
        [SuppressMessage("Microsoft.StyleCop.CSharp.DocumentationRules", "*", Justification = "MIME types are not recognised by the spelling checker.")]
        public const string ApplicationJsonUtf = "application/json; charset=utf-8";
        ...
        /// <summary>
        /// Represents application/xlsx (xlsx).
        /// </summary>
        [SuppressMessage("Microsoft.StyleCop.CSharp.DocumentationRules", "*", Justification = "MIME types are not recognised by the spelling checker.")]
        public const string ApplicationXlsx = "attachment; filename=export.xlsx";
