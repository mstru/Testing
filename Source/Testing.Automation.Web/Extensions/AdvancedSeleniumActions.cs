...
namespace Testing.Automation.Web.Extensions
{
    public static class AdvancedSeleniumActions
    {
        ...
        /// <returns></returns>
        public static DragAction<TParent> Drag<TParent>(this TParent parent, Func<TParent, IDraggable> getDraggable)
        ...
        /// <param name="miliseconds">The miliseconds.</param>
        /// <returns></returns>
        public static TParent WaitUntil<TParent>(this TParent parent, Predicate<TParent> condition,
            int miliseconds = 10000) where TParent : IBlock
        {
